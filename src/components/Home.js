      ...
      <Table className={classes.table}  stickyHeader aria-label="sticky table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="center">Fisrt Name</StyledTableCell>
        ...
        <TableBody >
          {users.map((user) => (
            <StyledTableRow key={user.id}>
              ...
              <StyledTableCell align="center"><img src={user.avatar} alt="" /></StyledTableCell>
